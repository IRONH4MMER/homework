function noParamFunc() {
    for (let arg of arguments) {
        console.log(arg, noParamFunc);
    }
};

noParamFunc(10, false, "google");
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function userInfo() {
    if (this.registered) {
...
const userRegistrInfo = {
    name: 'OLeg',
    registered: true,
    data: new Date(2020, 10, 2)
};
const userRegistrInfo1 = {
    name: 'NeOleg',
    registered: false,
    data: new Date()
}

userRegistrInfo.getInfo = userInfo;
userRegistrInfo1.getInfo = userInfo;
userRegistrInfo.getInfo();
userRegistrInfo1.getInfo();
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var users = {
    14587: {
        name: "Ivan",
